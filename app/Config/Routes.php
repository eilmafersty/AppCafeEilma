...
$routes->add('/users', 'UserController::delete');
...
$routes->get('/detail/delete/(:segment)', 'DetailController::delete/$l');
$routes->add('/detail/edit/(:segment)', 'DetailController::edit/$l');
